/**
 * Proxy: Client withdraw request.
 * POST /api/requests/[requestId]/withdraw/ → Backend POST /api/requests/<id>/withdraw/
 */
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({ detail: "Failed to withdraw request." }, { status: 500 });
  }
}
