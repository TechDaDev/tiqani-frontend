  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="filter-skill" className="text-xs font-medium text-gray-600 dark:text-gray-400">
          {t("skill")}
        </label>
        <select
          id="filter-skill"
      ...
      {/* Governorate */}
      <div className="flex flex-col gap-1">
        <label htmlFor="filter-governorate" className="text-xs font-medium text-gray-600 dark:text-gray-400">
          {t("governorate")}
        </label>
        <select
      ...
      {/* Availability */}
      <div className="flex flex-col gap-1">
        <label htmlFor="filter-availability" className="text-xs font-medium text-gray-600 dark:text-gray-400">
          {t("availability")}
        </label>
        <select
      ...
      {/* Min rating */}
      <div className="flex flex-col gap-1">
        <label htmlFor="filter-rating" className="text-xs font-medium text-gray-600 dark:text-gray-400">
          {t("minRating")}
        </label>
        <select
          id="filter-rating"
      ...
      {/* Sort */}
      <div className="flex flex-col gap-1">
        <label htmlFor="filter-sort" className="text-xs font-medium text-gray-600 dark:text-gray-400">
          {t("sortBy")}
        </label>
        <select
          id="filter-sort"
