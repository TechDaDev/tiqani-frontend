    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          <h3 className="truncate text-sm font-semibold text-foreground dark:text-gray-100">
            {request.title}
          </h3>
          ...
          <p className="mt-1 line-clamp-2 text-xs text-foreground-muted dark:text-gray-300">
            {request.description}
          </p>
